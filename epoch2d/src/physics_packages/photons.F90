...
CONTAINS
  ...
  ! For photons, chi. Same principle as for eta.
...
#include "triangle/b_part.inc"
  ...
  !!!!! Block 7: Linear Breit Wheeler (photon-photon smashing)
